      ...
      <div className="sub-parent-div">
        ...
        <div id="content-container">
          <div
            ...
            id="synopsis"
          >
            <div className="content-component" id="synopsis">
              <Synopsis />
            </div>
          </div>
          ...
          <div
            ...
            id="series-info"
          >
            <div className="content-component" id="series-info">
              <SeriesInfo />
            </div>
          </div>

          <div
            className={current === 3 ? "content active-content" : "content"}
            id="episodes"
          >
            <div className="content-component" id="episodes">
              <Episodes />
            </div>
          </div>

          <div
            className={current === 4 ? "content active-content" : "content"}
            id="art-gallery"
          >
            <div className="content-component" id="gallery">
              <Gallery />
            </div>
          </div>
        </div>
